...
namespace EventsScheduler {
	...
	private: System::Windows::Forms::PictureBox^ update_event_picture_box;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->update_event_picture_box = (gcnew System::Windows::Forms::PictureBox());
			this->event_prop_group_box->SuspendLayout();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->update_event_picture_box))->BeginInit();
			this->SuspendLayout();
			// 
			// save_button
			// 
			...
			this->save_button->Text = L"Update";
			...
			this->event_prop_group_box->TabIndex = 16;
			...
			// 
			// update_event_picture_box
			// 
			this->update_event_picture_box->BackgroundImageLayout = System::Windows::Forms::ImageLayout::Stretch;
			this->update_event_picture_box->Dock = System::Windows::Forms::DockStyle::Fill;
			this->update_event_picture_box->Location = System::Drawing::Point(0, 0);
			this->update_event_picture_box->Name = L"update_event_picture_box";
			this->update_event_picture_box->Size = System::Drawing::Size(434, 311);
			this->update_event_picture_box->TabIndex = 17;
			this->update_event_picture_box->TabStop = false;
			// 
			// UpdateEventForm
			// 
			...
			this->Controls->Add(this->update_event_picture_box);
			...
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->update_event_picture_box))->EndInit();
...
#pragma endregion
		private: System::Void UpdateEventForm_Load(System::Object^ sender, System::EventArgs^ e) {
			...
			edate_text_box->Text = DateTime::FromOADate(oldEvent->end_date).ToShortDateString();
			stime_hrs_combo_box->Text = DateTime::FromOADate(oldEvent->start_time).ToString("hh");
			stime_min_combo_box->Text = DateTime::FromOADate(oldEvent->start_time).ToString("mm");
			stime_dp_combo_box->Text = DateTime::FromOADate(oldEvent->start_time).ToString("tt");
			rtime_hrs_combo_box->Text = DateTime::FromOADate(oldEvent->reminder_time).ToString("hh");
			rtime_min_combo_box->Text = DateTime::FromOADate(oldEvent->reminder_time).ToString("mm");
			rtime_dp_combo_box->Text = DateTime::FromOADate(oldEvent->reminder_time).ToString("tt");

			String^ folderPath = Application::StartupPath;
			folderPath += "\\resources\\main\\";
			String^ fileName = "temp.jpg";
			update_event_picture_box->Image = Image::FromFile(folderPath + fileName);
			save_button->Parent = update_event_picture_box;
			save_button->BackColor = Color::Transparent;
			cancel_button->Parent = update_event_picture_box;
			cancel_button->BackColor = Color::Transparent;
			event_prop_group_box->Parent = update_event_picture_box;
